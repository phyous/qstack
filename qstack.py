...
def main():
    ...
    try:
        gs = GoogleSearch("stackoverflow.com: overflow error python")
    ...
    search_result = Xoverflow(stack_overflow_url).get_results()
    #print search_result
    
    res = stack_overflow_url#(search_result, stack_overflow_url)
